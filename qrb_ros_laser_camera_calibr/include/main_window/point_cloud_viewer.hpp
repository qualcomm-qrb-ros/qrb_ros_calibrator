...
public:
  ...
  void load_cloud(const qrb::laser_cam_calibrator::LaserData & laser_data);
  void draw_line(const pcl::PointXYZ & p1, const pcl::PointXYZ & p2);
  void updata_laser_data(const qrb::laser_cam_calibrator::LaserData & laser_data);

private:
  QVTKOpenGLNativeWidget * vtk_widget_;
  vtkSmartPointer<vtkRenderer> renderer_;
  qrb::laser_cam_calibrator::LaserData laser_data_;
};
#endif
